...
WHERE OPTIONS LIKE '%통풍시트%' OR LIKE '%가죽시트%' OR LIKE '%열선시트%' GROUP BY CAR_TYPE ORDER BY CAR_TYPE ASC;
SELECT CAR_TYPE, COUNT(*) AS CARS FROM CAR_RENTAL_COMPANY_CAR WHERE OPTIONS IN('%가죽시트%') GROUP BY CAR_TYPE;



/*
SELECT * FROM MEMBER_PROFILE;
SELECT * FROM MEMBER_PROFILE WHERE DATE_OF_BIRTH LIKE'______3%'ORDER BY DATE_OF_BIRTH ASC;
